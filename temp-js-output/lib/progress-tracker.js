...
class ProgressTracker {
    ...
    update(stage, message) {
        ...
        this.spinner.text = `${progress} ${message} ${chalk_1.default.gray(`(${elapsed})`)}`;
    }
    succeed(message) {
        if (!this.enabled || !this.spinner) {
            if (this.enabled) {
        ...
        const elapsed = this.getElapsedTime();
        this.spinner.succeed(`${message} ${chalk_1.default.gray(`(${elapsed})`)}`);
        this.spinner = null;
    }
    fail(message) {
        if (!this.enabled || !this.spinner) {
        ...
        const elapsed = this.getElapsedTime();
        this.spinner.fail(`${message} ${chalk_1.default.gray(`(${elapsed})`)}`);
        this.spinner = null;
    }
    warn(message) {
        if (!this.enabled || !this.spinner) {
        ...
        const elapsed = this.getElapsedTime();
        this.spinner.warn(`${message} ${chalk_1.default.gray(`(${elapsed})`)}`);
        this.spinner = null;
    }
    info(message) {
        if (!this.enabled || !this.spinner) {
        ...
        const elapsed = this.getElapsedTime();
        this.spinner.info(`${message} ${chalk_1.default.gray(`(${elapsed})`)}`);
        this.spinner = null;
    }
    stop() {
        if (this.spinner) {
