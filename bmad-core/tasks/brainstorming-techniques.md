...
for ideation and innovative thinking. The analyst can use these techniques to
facilitate productive brainstorming sessions with users.
...
5. **SCAMPER Method** [[LLM: Guide through each SCAMPER prompt systematically.]]
