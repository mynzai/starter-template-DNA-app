...
If the user has markdown-tree-parser installed, use it and skip the manual
process below.
...
7. **Template markup**: If documents contain {{placeholders}} or
   [[LLM instructions]], preserve exactly]]
