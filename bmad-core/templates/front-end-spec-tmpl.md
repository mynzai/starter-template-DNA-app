...
flows, and visual design specifications for {{Project Name}}'s user interface.
...
[[LLM: Work with the user to establish and document the following. If not
already defined, facilitate a discussion to determine:
...
1. **Clarity over cleverness** - Prioritize clear communication over aesthetic
   innovation
...
[[LLM: Collaborate with the user to create a comprehensive information
architecture:
...
[[LLM: Clarify where detailed visual designs will be created (Figma, Sketch,
etc.) and how to reference them. If low-fidelity wireframes are needed, offer to
help conceptualize layouts for key screens.
...
[[LLM: Discuss whether to use an existing design system or create a new one. If
creating new, identify foundational components and their key states. Note that
detailed technical specs belong in front-end-architecture.
...
[[LLM: Link to existing style guide or define key brand elements. Ensure
...
|:--------|:-----|:-------|:------------| | H1 | {{h1_size}} | {{h1_weight}} |
{{h1_line}} | | H2 | {{h2_size}} | {{h2_weight}} | {{h2_line}} | | H3 |
{{h3_size}} | {{h3_weight}} | {{h3_line}} | | Body | {{body_size}} |
{{body_weight}} | {{body_line}} | | Small | {{small_size}} | {{small_weight}} |
{{small_line}} |
...
[[LLM: Define specific accessibility requirements based on target compliance
...
[[LLM: Define breakpoints and adaptation strategies for different device sizes.
Consider both technical constraints and user contexts.
...
[[LLM: Define motion design principles and key interactions. Keep performance
...
- **{{animation_name}}:** {{animation_description}} (Duration: {{duration}},
  Easing: {{easing}}) <</REPEAT>>
